...
# -*- coding: utf-8 -*-
"""
Created on Sun Aug 23 10:38:37 2020
...
import numpy as np
def spl(X, y, i, j):
    X_train, X_test, y_train, y_test = train_test_split(X, y, train_size = i, random_state = j, stratify = y) 
    return X_train
    return y_train

def feature(data):
    datafile_name = "saved_data.pkl"
